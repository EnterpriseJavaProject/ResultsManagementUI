...
import { Student } from "../student/interfaces/models";
...
@Component({
  ...
  styleUrls: ['./upload-grade.component.css']
})
export class UploadGradeComponent implements OnInit {
  displayedColumns: string[] = ['student_id', 'full_name', 'action'];
    ...
    ngOnInit(): void {
      ...
      this.VOForm = this._formBuilder.group({
       ...
       this.VOForm = this.fb.group({
                VORows: this.fb.array(this.data.map(val => this.fb.group({
                  student_id: new FormControl(val.student_id),
                  full_name: new FormControl(val.full_name),
