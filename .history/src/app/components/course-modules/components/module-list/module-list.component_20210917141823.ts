...
export class ModuleListComponent implements OnInit {
  ...
  cardsData: CardItem[] = [
    { messages:[{headerMessage:'Total Modules',headerValue:'14'} ], headerIcon: 'fas fa-th', headerColor:'#ef5350'},
    { messages:[{headerMessage: 'Active Modules',headerValue:'10'} ], headerIcon: 'fas fa-eye',headerColor:'#68EF50' },
    { messages:[{headerMessage: 'Inactive Modules',headerValue:'10'} ], headerIcon: 'fas fa-eye-slash',headerColor:'#50C8EF' },
